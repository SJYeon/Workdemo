...
<body>
    ...
    <div class="middle">
        <div class="content" style="background-image:url(images/regbg.png)">
            <div class="right">
                <div class="right-head">
                   ...
                   <div class="userinfo">
                    <form class="userpwd" action="login">
                        <div class="user">
                            <i class="iconfont">&#xe626;</i>
                            <input class="username" type="text" name="users.phone" placeholder="  昵称/手机号"/>
                        </div>
                        <div class="pwd">
                            <i class="iconfont">&#xe614;</i>
                            <input class="password" type="password" name="users.password" placeholder="  密码"/>
                        </div>
